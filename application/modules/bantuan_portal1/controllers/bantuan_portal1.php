...
class bantuan_portal1 extends MX_Controller {

	function __construct()
	{
		parent::__construct();
		// model
		 $this->load->model('m_bantuan_portal1');
	...
	{
		$data = array(
			'namamodule' 	=> "bantuan_portal1",
			'namafileview' 	=> "V_bantuan_portal1",
			'tampil'		=> $this->m_bantuan_portal1->tampil(),
		);
