<ol class="breadcrumb">
  ...
  <!-- Icon Cards-->
  <div class="row">
    <div class="col-xl-4 col-sm-6 mb-2"  style="margin-left: 15%;">
      <div class="card dashboard text-white bg-primary o-hidden h-100">
        <div class="card-body">
          <div class="card-body-icon">
            <i class="fa fa-fw fa-envelope-open"></i>
          </div>
          <div class="mr-5"><h5>Jumlah undangan terkirim</h5></div>
        </div>
        <a class="card-footer text-white clearfix small z-1" href="invite.html">
      ...
      <div class="card dashboard text-white bg-warning o-hidden h-100">
        <div class="card-body">
          <div class="card-body-icon">
            ...
            <div class="mr-5"><h5>Jumlah karyawan</h5></div>
        </div>
