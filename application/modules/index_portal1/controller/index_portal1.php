...
class index_portal1 extends MX_Controller {

	function __construct()
	{
		parent::__construct();
		// model
		 $this->load->model('m_index_portal1');
	...
	{
		$data = array(
			'namamodule' 	=> "index_portal1",
			'namafileview' 	=> "V_index_portal1",
			'tampil'		=> $this->m_index_portal1->tampil(),
		);
