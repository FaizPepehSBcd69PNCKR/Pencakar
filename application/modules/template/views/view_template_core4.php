...
<body>
	...
	<header class="header menu_fixed">
		...
		<ul id="top_menu">
			...
			<li class="nav-item">
           <li><a href="#sign-in-dialog" id="sign-in"  class="btn btn-info" title="Sign In" style="font-size: 13px;">Log Out</a></li>
        </li>
    </a>
		...
		<nav id="menu" class="main-menu">
			<ul>
				...
				<li><span><a href="grid-listings-filterscol.html">Calon Karyawan</a></span>
					<ul>
						<li>
							<span hidden="hidden"><a href="#0">Calon Karyawan</a></span>
							<ul>
						...
						<li>
							...
							<ul>
								<li hidden="hidden"><a href="detail-hotel.html">Lebih Detail</a></li>
							</ul>
						</li>
				...
				<li><span><a href="#0">Halaman</a></span>
					<ul>
						<li><a href="akun-karyawan/index.html">Akun Saya</a></li>
